Type tank
Field name$  ;имя игрока
Field corpus  ;модель корпуса
Field turret    ;модель башни
Field stvol       ;модель ствола
Field sh               ;тень
;-------------корпус-------------
;позиция
Field xc#
...
Field collignW   ;коллижн со стеной
...
Field fire ;команда на выстрел пушки
Field fire2 ;команда на выстрел ракеты
End Type
;=========================
Type objekt
	Field en             ;model
